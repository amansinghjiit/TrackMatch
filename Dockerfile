...
ENV DRIVER_VERSION=134.0.6998.117

RUN wget -q "https://chromedriver.storage.googleapis.com/$DRIVER_VERSION/chromedriver_linux64.zip" -O chromedriver_linux64.zip && \
